...
public class CodegenConstants {
    ...
    public static final String PARAM_PROPERTY_NAMING = "paramPropertyNaming";
    public static final String PARAM_PROPERTY_NAMING_DESC = "Naming convention for parameter properties: 'camelCase', 'PascalCase', 'snake_case' and 'original', which keeps the original name";
    ...
    public static enum PARAM_PROPERTY_NAMING_TYPE {camelCase, PascalCase, snake_case, original}
